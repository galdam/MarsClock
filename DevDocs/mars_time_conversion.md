...
* Convert to seconds since the Julian 2K epoch (12:00, 1 Jan 2000); the deltaJ2K. Julian dates do not use leap seconds or leap days so these may need to be corrected for.
...
Mars years in the Darian calendar use the 'telescopic' epoch, which uses Kepler's observations of Mars as it's starting date. This has the advantage that it places observations of Mars and recorded events in positive values.
