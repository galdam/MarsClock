...
class FrameBuffer:
    ...
    def text(self, s, x, y, color):
        ...
        _font = BitmapFont(font_name)
        _font.draw_text(self, s, x, y, color)
...
class BitmapFontOLD:
    ...
    def __init__(self, font_name="font5x8.bin"):
        ...
        self.font_path = os.path.join(os.path.dirname(__file__),  self.font_name)
        ...
        try:
            ...
            if 2 + 256 * self.font_width != os.stat(self.font_path)[6]:
                raise RuntimeError("Invalid font file: " + self.font_path)
        except OSError:
